#!/usr/bin/env python3
"""
Simple script to run the textbook content ingestion from sitemap using Gemini embeddings.
This version initializes the vector store only when needed to avoid connection issues.
"""
import asyncio
import sys
import os
